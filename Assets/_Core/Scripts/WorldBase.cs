...
public class WorldBase : MonoBehaviour {
	...
	void Start () {
        ...
        transform.DOScaleX(oldScale.x * (1 + percentage), 5f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
        transform.DOScaleY(oldScale.y * (1 - percentage), 5f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
        transform.DOScaleZ(oldScale.z * (1 + percentage), 5f).SetLoops(-1, LoopType.Yoyo).SetEase(Ease.InOutSine);
        /*
