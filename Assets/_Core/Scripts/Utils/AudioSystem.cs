...
public class AudioSystem : MonoBehaviour
{
    ...
    private const float startMusicVolume = 1f;
    private const float startEffectsVolume = 1f;

    private const float startDefaultPitch = 1f;
    private const float startMusicPitch = 1f;
